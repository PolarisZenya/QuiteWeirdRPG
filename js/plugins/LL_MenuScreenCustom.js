//=============================================================================
// RPGツクールMZ - LL_MenuScreenCustom.js v1.2.3
//-----------------------------------------------------------------------------
// ルルの教会 (Lulu's Church)
...
(() => {
	...
	const rightBottomBlockAlign = String(parameters["rightBottomBlockAlign"] || "right");
	// 背景画像の設定
	...
	Window_MenuHelp.prototype.drawMenuHelp = function() {
		...
		const oneThirdWidth = Math.floor(this.innerWidth / 3);
		this.resetTextColor();
		this.drawText(this._text ? this._text : "", 0, y, this.innerWidth - oneThirdWidth * 1.5);
	};
})();
